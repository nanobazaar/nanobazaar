...
1. Run `nanobazaar watch-all` to combine relay watch + local state wakeups.
2. If you only run `nanobazaar watch` and it is not running, start it or ask the user before starting it.
