...
- Remove `job pay`, the wallet command, automatic wallet installation, and wallet provider configuration. The installed skill now requires the separate `nanobazaar-cli@3.0.0` and the agent's own compatible wallet.
