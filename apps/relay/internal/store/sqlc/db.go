...
func Prepare(ctx context.Context, db DBTX) (*Queries, error) {
	...
	if q.deleteJobsTerminalBeforeStmt, err = db.PrepareContext(ctx, deleteJobsTerminalBefore); err != nil {
		return nil, fmt.Errorf("error preparing query DeleteJobsTerminalBefore: %w", err)
	}
	...
	if q.deleteOffersBeforeStmt, err = db.PrepareContext(ctx, deleteOffersBefore); err != nil {
		return nil, fmt.Errorf("error preparing query DeleteOffersBefore: %w", err)
	}
	...
	if q.getPayloadRecipientStmt, err = db.PrepareContext(ctx, getPayloadRecipient); err != nil {
		return nil, fmt.Errorf("error preparing query GetPayloadRecipient: %w", err)
	}
...
func (q *Queries) Close() error {
	...
	if q.deleteJobsTerminalBeforeStmt != nil {
		if cerr := q.deleteJobsTerminalBeforeStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing deleteJobsTerminalBeforeStmt: %w", cerr)
		}
	}
	...
	if q.deleteOffersBeforeStmt != nil {
		if cerr := q.deleteOffersBeforeStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing deleteOffersBeforeStmt: %w", cerr)
		}
	}
	...
	if q.getPayloadRecipientStmt != nil {
		if cerr := q.getPayloadRecipientStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing getPayloadRecipientStmt: %w", cerr)
		}
	}
